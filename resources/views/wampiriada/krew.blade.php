...
@section('content')
    ...
    <object type="application/pdf" data="{{ url('materialy/krewplus-11.pdf') }}" width="100%" height="100%">
        <p><a download="krewplus.pdf" href="{{ url('materialy/krewplus-11.pdf') }}">Pobierz ulotkę Krew Plus</a>.</p>
    </object>
@stop
